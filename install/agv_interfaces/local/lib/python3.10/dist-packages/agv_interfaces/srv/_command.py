...
class Metaclass_Command(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from agv_interfaces.srv import _command
...
class Command(metaclass=Metaclass_Command):
    from agv_interfaces.srv._command import Command_Request as Request
    from agv_interfaces.srv._command import Command_Response as Response
