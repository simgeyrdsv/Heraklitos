...
#include "agv_interfaces/srv/detail/command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const agv_interfaces::srv::Command_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  agv_interfaces::srv::Command_Request & ros_message)
{
  // Member: command
  cdr >> ros_message.command;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = agv_interfaces::srv::Command_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const agv_interfaces::srv::Command_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<agv_interfaces::srv::Command_Request *>(
    untyped_ros_message);
...
{
  return &agv_interfaces::srv::typesupport_fastrtps_cpp::_Command_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, agv_interfaces, srv, Command_Request)() {
  return &agv_interfaces::srv::typesupport_fastrtps_cpp::_Command_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_agv_interfaces
cdr_serialize(
  const agv_interfaces::srv::Command_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  agv_interfaces::srv::Command_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = agv_interfaces::srv::Command_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const agv_interfaces::srv::Command_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<agv_interfaces::srv::Command_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &agv_interfaces::srv::typesupport_fastrtps_cpp::_Command_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, agv_interfaces, srv, Command_Response)() {
  return &agv_interfaces::srv::typesupport_fastrtps_cpp::_Command_Response__handle;
}
...
{
  return &agv_interfaces::srv::typesupport_fastrtps_cpp::_Command__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, agv_interfaces, srv, Command)() {
  return &agv_interfaces::srv::typesupport_fastrtps_cpp::_Command__handle;
}
